  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex" style={{ height: "500px" }}>
        {/* Left side with Image and Navbar */}
        ...
        <div className="w-1/2 bg-gray-300 flex flex-col justify-center items-center space-y-4 p-6">
          <div className={`transition-all duration-1000 transform ${animateText ? "opacity-100 translate-x-0" : "opacity-0 translate-x-20"}`}>
            ...
            <h1 className="text-3xl font-bold text-gray-800 pt-10 pb-4">Digvijay Bhonsle</h1>
            <h3 className="text-md font-medium text-gray-600 pb-11">Software Developer Engineer Enthusiast / Problem Solver</h3>
